...
- [ ] **Phase 9: SaaS UI / Landing Page** — Marketing page, onboarding, pricing page, upgrade prompts
  - **Plans:** 5 plans
  - Plans:
    - [ ] 09-01-PLAN.md — Wave 0: add 3 failing tests to server.test.js (pricing + onboarding auth gate)
    - [ ] 09-02-PLAN.md — Wave 1: server.js — add GET /pricing route + /onboarding auth gate (getAuth inline)
...
| 9. SaaS UI / Landing Page | v2.0 | 0/5 | Not started | - |
